...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=0.5, max_rotation_angle=5,
                 ...
                 is_addNoise=False, is_changeLight=True, is_cutout=False, is_rotate_img_bbox=False,
                 is_crop_img_bboxes=False, is_shift_pic_bboxes=False, is_filp_pic_bboxes=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='D:/jiazaosheng/images1')
    parser.add_argument('--source_xml_path', type=str, default='D:/jiazaosheng/xml1')
    parser.add_argument('--save_img_path', type=str, default='D:/jiazaosheng/images2')
    parser.add_argument('--save_xml_path', type=str, default='D:/jiazaosheng/xml2')
